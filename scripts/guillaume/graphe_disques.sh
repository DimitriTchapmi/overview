...
l_couleurs=(FF3333 FF6A33 3733FF 33B7FF 465C2B 8CFF00 4403FB FB0391)      # rouge, bleu, vert, violet 
  ...
  do
    ...
    commande="$commande DEF:$partition""_used=/var/www/overview/projets/$2/supervision/$3/bases/disque_$disque.rrd:$partition""_used:AVERAGE AREA:$partition""_used#$couleur_a:'espace_utilisé_sur_la_partition_$partition':STACK DEF:$partition""_free=/var/www/overview/projets/$2/supervision/$3/bases/disque_$disque.rrd:$partition""_free:AVERAGE AREA:$partition""_free#$couleur_b:'espace_libre_sur_la_partition_$partition':STACK"
    let "i+=2"
    let "j+=2"
  done
done
