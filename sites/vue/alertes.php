...
for($i=0;$i<count($alertes);$i++){
  ...
  if($alertes[$i]["flag"] == 1 ){
    echo "<td style='width: 300px; height: 25px; color='red'>Alerte déclenchée depuis ".$alertes[$i]["temps_atteint"]." minutes</td>";
  }else{
  	echo "<td  style='width: 300px; height: 25px; color='blue'>Tout est normal</td>";
  }
